...
DeesseJS provides the essential building blocks for creating applications without attempting to provide every possible feature out of the box.
...
Give developers the strongest possible foundation to build amazing applications, without dictating how those applications should work.
